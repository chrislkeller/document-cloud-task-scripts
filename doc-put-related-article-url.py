"""
file: doc-put-related-article-url.py
...
def update_document_related_article_url(project_id, related_article_url):
    ...
    for document in list_of_project_documents:
        ...
        obj.related_article = related_article_url
...
if __name__ == "__main__":
    update_document_related_article_url(MY_PROJECT_ID, "#")
